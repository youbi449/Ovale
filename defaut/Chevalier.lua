...
SpellInfo(EMPOWERRUNEWEAPON cd=300)
...
AddIcon help=cd
{
	...
	if SpellKnown(UNBREAKABLEARMOR) Spell(UNBREAKABLEARMOR usable=1)
	...
	if SpellKnown(EMPOWERRUNEWEAPON) Spell(EMPOWERRUNEWEAPON usable=1)
